...
export function Hero() {
  return (
    <section
      id="home"
      className="relative bg-white overflow-hidden pt-24 md:pt-40 pb-20"
    >
      <div className="max-w-[1440px] mx-auto px-4 sm:px-6 lg:px-8 relative z-10 text-center flex flex-col items-center">
        <motion.div
          ...
          className="space-y-10 md:space-y-16 w-full flex flex-col items-center"
        >
          {/* Main Title */}
          <div className="space-y-8">
            <h1 className="text-2xl sm:text-3xl md:text-4xl lg:text-6xl font-serif text-brand-heading leading-tight tracking-[0.1em] uppercase max-w-5xl mx-auto font-medium px-2">
          ...
          <div className="max-w-4xl mx-auto space-y-10">
            ...
            {/* Badges */}
            <div className="flex flex-col gap-10 pt-16 border-t border-brand-border">
