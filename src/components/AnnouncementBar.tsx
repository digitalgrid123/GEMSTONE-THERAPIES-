      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          <motion.p
            ...
            className="text-[9px] sm:text-[11px] md:text-xs font-bold tracking-widest sm:tracking-[0.15em] uppercase text-center leading-tight hover:opacity-80 transition-opacity px-2"
          >
